...
$.extend($.validator, {
	...
	messages: {
		required: "<span class=\"required\">Ce champ est requis.</span>",
		...
		rangelength: $.validator.format("Veuillez saisir une valeur comprise entre {0} et {1} caractères de longueur."),
